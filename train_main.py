...
def train_lstm_classifier_14(data_df, num_data_points, data_date):
    window_size = cf["data"]["window_size"]
...
def train_lstm_classifier_1(data_df, num_data_points, data_date):
    window_size = cf["data"]["window_size"]
    sma = utils.SMA(data_df['4. close'].values, window_size)
    ema = utils.EMA(np.array(data_df['4. close']), cf['data']['smoothing'], window_size)
    rsi = utils.RSI(data_df, window_size)
...
if __name__ == "__main__":
    ...
    train_lstm_classifier_14(data_df, num_data_points, data_date)
    # train_lstm_classifier_1(data_df, num_data_points, data_date)