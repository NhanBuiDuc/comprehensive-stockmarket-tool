...
def to_plot(dataset_test, dataset_val, y_test, y_val, num_data_points, dates, test_dates, val_dates):
    ...
    if cf["plots"]["show_plots"]:
        ...
        plt.plot(plot_date_test, to_plot_data_y_val, label="Actual prices", marker=".", markersize=10, color=cf["plots"]["color_actual"])
        plt.plot(plot_date_test, to_plot_data_y_val_pred, label="Past predicted prices", marker=".", markersize=10, color=cf["plots"]["color_pred_val"])
        # plt.plot(plot_date_test, y_test, label="Predicted price for next day", marker=".", markersize=20, color=cf["plots"]["color_pred_test"])
